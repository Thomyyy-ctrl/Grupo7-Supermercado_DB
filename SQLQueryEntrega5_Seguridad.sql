...
BEGIN
    BEGIN TRY
        ...
        -- Inserta los valores en la tabla NotasDeCredito
        INSERT INTO esquema_operaciones.NotasDeCredito (nroFactura, tipoDeFactura, TipoDeCliente, Fecha, Valor, Motivo)
