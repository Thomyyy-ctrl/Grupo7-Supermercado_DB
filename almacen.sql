...
PRINT 'Tabla producto creada.'
	END
go
alter table esquema_Producto.Producto alter column unidad_Referencia varchar (10)
go
...
ALTER TABLE esquema_Ventas.ventasRegistradas ALTER COLUMN  idIdentificador varchar(80)
GO
